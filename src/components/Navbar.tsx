...
const Navbar = () => {
 ...
 return <nav className={`fixed top-0 left-0 right-0 z-50 ${scrolled||menuOpen?"bg-background/95 backdrop-blur shadow":"bg-transparent"}`}>
 <div className="container flex items-center justify-between px-6 py-4"><a href="/" className="flex items-center gap-3"><img src={logoImg} alt="Re Start Coffee" className="w-8 h-8 object-contain"/><span className="font-display text-lg font-semibold">Re · Start</span></a>
