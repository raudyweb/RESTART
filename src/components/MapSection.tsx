    ...
    <div className="container px-6">
      ...
      <div className="grid md:grid-cols-2 gap-8 items-start">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-full bg-primary/10 text-primary flex items-center justify-center shrink-0"><Phone size={18} /></div>
            <div>
          ...
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-full bg-primary/10 text-primary flex items-center justify-center shrink-0"><Mail size={18} /></div>
            <div>
              <h3 className="font-display text-lg font-semibold mb-1">Email</h3>
              <a href="mailto:rscafevng@gmail.com" onClick={(e) => { e.preventDefault(); window.open("https://mail.google.com/mail/u/0/#compose?to=rscafevng@gmail.com", "_blank"); }} className="text-muted-foreground hover:text-foreground transition-colors cursor-pointer">rscafevng@gmail.com</a>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-full bg-primary/10 text-primary flex items-center justify-center shrink-0"><Instagram size={18} /></div>
            <div>
          ...
          <a href="https://maps.app.goo.gl/BL8ZWwjTquyxNPD16" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-foreground text-white px-6 py-3 rounded-md font-semibold hover:opacity-90 transition-opacity w-fit mt-2">Cómo llegar</a>
        </div>
      </div>
    </div>
  </section>
